...
<table class="plain">
	...
	<tr><th>Rule&nbsp;3</th><td>Entities Used</td><td>All Entities with pingback properties declared, as per Rule 2, must only be <em>used</em> or otherwise consumed by Activities, not <em>wasGeneratedBy</em> an Activity or indicated as being <em>wasDerivedFrom</em> any other Entity. Anything reported as having been generated in new provenance information cannot already have pre-existing provenance for a pingbacked message payload to be added to.</code></td></tr>	
</table>
